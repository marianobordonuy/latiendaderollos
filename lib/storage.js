...
export const PRECIOS_DEFAULT = {
    "10x15": { precio_1_20: 60,  precio_21_50: 60,  precio_51_100: 60,  precio_101_mas: 60,  activo: true  },
    "13x18": { precio_1_20: 90,  precio_21_50: 90,  precio_51_100: 90,  precio_101_mas: 90,  activo: true  },
    "15x21": { precio_1_20: 120, precio_21_50: 120, precio_51_100: 120, precio_101_mas: 120, activo: true  },
    "20x30": { precio_1_20: 180, precio_21_50: 180, precio_51_100: 180, precio_101_mas: 180, activo: false }
}
...
export function precioUnitario(info, qty) {
    if (qty > 100) return info.precio_101_mas
    if (qty > 50)  return info.precio_51_100
...
export function loadPrecios() {
    ...
    for (const [size, val] of Object.entries(data)) {
        if (typeof val.precio_1_20 !== "number") {
            data[size] = {
                ...
                precio_51_100:  val.precio,
                precio_101_mas: val.precio,
                activo:         val.activo
            }
            migrated = true
        }
    ...
    // Migración de 3 tramos (1-20/21-50/51+) a 4 tramos (agrega 51-100/101+)
    for (const [size, val] of Object.entries(data)) {
        if (typeof val.precio_51_100 !== "number") {
            const base = val.precio_51_mas ?? val.precio_1_20
            data[size] = {
                precio_1_20:    val.precio_1_20,
                precio_21_50:   val.precio_21_50,
                precio_51_100:  base,
                precio_101_mas: base,
                activo:         val.activo
            }
